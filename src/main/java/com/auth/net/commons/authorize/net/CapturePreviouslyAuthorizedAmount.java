...
public class CapturePreviouslyAuthorizedAmount {
	...
	public static void main(String[] args) {
		...
		txnRequest.setAmount(new BigDecimal(260.00));
		...
		captureTxnRequest.setRefTransId(transactionId);
		...
		CreateTransactionResponse captureResponse = controller.getApiResponse();
