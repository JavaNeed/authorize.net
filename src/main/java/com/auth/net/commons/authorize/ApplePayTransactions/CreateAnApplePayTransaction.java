package com.auth.net.commons.authorize.ApplePayTransactions;
...
public class CreateAnApplePayTransaction {
	...
	public static void main(String[] args) {
		...
		CreateTransactionController transactionController = new CreateTransactionController(createTransactionRequest);
		transactionController.execute();
		
		// Getting the response
		CreateTransactionResponse response = transactionController.getApiResponse();
		...
		if (response != null){
			if(response.getMessages().getResultCode() == MessageTypeEnum.OK){
				if (response.getTransactionResponse() != null){
					...
					System.out.println("Prepaid Card   : "+result.getPrePaidCard());
